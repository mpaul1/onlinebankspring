        ...
        <div class="d-flex flex-column text-center">
          <form:form action="login" modelAttribute="customer" method="post">
            <div class="form-group">
              <%-- <form:input type="email" path="email" class="form-control" id="email1" placeholder="Your email address..."> --%>
              <form:input type="email" class="form-control" path="email" id="email1" placeholder="Your Email" data-rule="email" data-msg="Please enter a valid email" />
              <div class="validation"></div>
            </div>
            <div class="form-group">
              <%-- <form:password type="password" path="password" class="form-control" id="password1" placeholder="Your password..."> --%>
              <form:input type="password" class="form-control" path="password" id="password" placeholder="Your Password" data-rule="minlen:8" data-msg="Please enter at least 8 chars" />
            	<div class="validation"></div>
            </div>
					...
					<ul class="banner_slide_bg">
						<li>
							<div class="w3ls_banner_txt">
								...
								<a href="openaccount" class="btn btn-banner1 my-3">Get Started</a>
							</div>
						</li>						
						<li>
							<div class="w3ls_banner_txt">
