...
<body>
		...
		<div class="container py-1">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item" aria-current="page">Check Order Received</li>
				</ol>
			</nav>
		</div>
	</div>
	...
	<section class="contact py-5">
		<div class="container py-lg-5">
			<h2 class="heading mb-sm-1 mb-1">Thank you for your check order, please expect them via mail within 1-2 weeks.</h2><br>
		</div>
	</section>
